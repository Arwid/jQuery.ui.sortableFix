...
2. If the option 'appendTo' is set to an outside element and the list is scrollable, jQuery.ui.sortable will still deal with the overflowing items. It shouldn't.
  This becomes a bigger issue when you have multiple lists; specifically an overflowing list on top of another.
